...
// https://github.com/ysh329/OpenMP-101/blob/master/Mattson_OMP_exercise/matmul_recur.cpp
...
//double dabs(double d){return (d<0.0?d:(-d));} // initially, it was an error here
